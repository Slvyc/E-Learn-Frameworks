            ...
            <form method="POST" action="{{ url('/register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 text-black"
                        required>
                </div>
                <div>
