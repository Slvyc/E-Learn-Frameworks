<x-filament-panels::page>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Progress Card -->
        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1">
        ...
        <!-- Chapters Card -->
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1">
    ...
    <!-- Optional: Additional Statistics Section -->
    <div class="mt-8 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="text-center p-4 bg-gray-50 rounded-lg">
                <p class="text-sm text-gray-600">Chapter per Framework</p>
                <p class="text-2xl font-bold text-gray-900">
                    {{ $totalFrameworks > 0 ? number_format($totalChapters / $totalFrameworks, 1) : '0' }}
                </p>
            </div>
            <div class="text-center p-4 bg-gray-50 rounded-lg">
                <p class="text-sm text-gray-600">Tingkat Aktivitas</p>
                <p class="text-2xl font-bold text-gray-900">
